...
public class WizardExtract extends Wizard {
	...
	public boolean performFinish() {
		...
		//cria uma inst‰ncia do UtilJavaModel para realizar cria›es de ClassDeclaration, MethodDeclaration, FieldDeclaraction, etc.
		UtilJavaModel utilJavaModel = new UtilJavaModel();
		
		
		//cria uma inst‰nca do UtilKDMModel para realizar cria‹o de ClassUnit, MethodUnit, storableUnit, etc..
